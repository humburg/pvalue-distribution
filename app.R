...
ui <- fluidPage(
  ...
  div(class="col-lg-8", style="max-width:1200px;",
      ...
      fluidRow(
        column(6, align="center", sliderInput("nullDiff", "Actual baseline difference between group means",
                                              min=-1, max=1, value=0, step=0.1),
               sliderInput("nullVar", "Pre-treatment variance", min=0.1, max=10, value=1),
               plotOutput("nullPlots")),
        column(6, align="center", sliderInput("altDiff", "Difference between group means due to treatment",
